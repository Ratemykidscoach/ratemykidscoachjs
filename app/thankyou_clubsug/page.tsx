...
export default function ThankYouClubSug() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#A8BCA1] to-[#8a9d85] flex items-center justify-center px-5 py-5">
      <div className="max-w-2xl w-full bg-white rounded-sm py-16 px-12 md:px-14 text-center shadow-[0_10px_40px_rgba(0,0,0,0.15)]">
        ...
        <p className="text-lg text-[#4a4a4a] mb-9 leading-7">
          We've received your club suggestion and appreciate you helping us expand our database.
        </p>
        ...
        <div className="bg-[#F9F7F4] p-8 rounded-sm border-l-4 border-[#A8BCA1] mb-9 text-left">
          ...
          <p className="text-[15px] text-[#2d2d2d] leading-7 mb-3">
            We'll review your club suggestion and add it to our database as we continue building out the platform. We're prioritizing clubs based on where parents need reviews most.
          </p>
          <p className="text-[15px] text-[#2d2d2d] leading-7">
            <strong className="text-[#1a1a1a] font-semibold">We'll email you when our official site goes live!</strong> When the club you suggested is added, you'll be able to leave reviews and help other parents in your community make informed decisions.
          </p>
        </div>
